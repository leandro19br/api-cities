 ...
 * Created by Leandro Saniago on 23/11/2021 - 19:19.
 * classe responsável por ensinar o hybernate a utilizar a geolocalização do tipo Point
 */
public class PointType implements UserType {
    ...
    return new Point(points[0], points1);*/
        ...
        /* 2nd  PGpoint é uma classe do Postgres de geolocalização*/
